...
-----
Autor: 		John Resig
Copyright:  Copyright (C) The jQuery Foundation.
Licenses:	GNU General Public License (GPL) & MIT

Timepicker
-----
Autor: 		François Gélinas
Copyright:  Copyright (C) François Gélinas.
Licenses:	GNU General Public License (GPL) & MIT

Validate
-----
Autor: 		Rick Harrison
Copyright:  Copyright (C) Rick Harrison.
Licenses:	GNU General Public License (GPL) & MIT

JCROP
-----
Autor: 		Kelly Hallman and Deep Liquid Group 
Copyright:  Copyright (C) Kelly Hallman and Deep Liquid Group .
License:	MIT
...
-----
Autor: 		Dev7studios
Copyright:  Copyright (C) 2011 Dev7studios.
License:	MIT

jRating
-----
Autor: 		ALPIXEL
Copyright:  Copyright (C) 2013 ALPIXEL.
License:	MIT
